...
public class SeaFoodNYAdapter extends RecyclerView.Adapter<SeaFoodNYAdapter.SeaNYViewHolder> {

    private ArrayList<CheckBoxListNew> myVeganSideItem;
    private Context myContext;


    public SeaFoodNYAdapter(Context context, ArrayList<CheckBoxListNew> mRadio) {
    ...
    @NonNull
    @Override
    public SeaNYViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(myContext).inflate(R.layout.sub_course_item, parent,false);
        SeaNYViewHolder rbv = new SeaNYViewHolder(view);
        return rbv;
    }

    @Override
    public void onBindViewHolder(@NonNull SeaNYViewHolder holder, int position) {
    ...
    public class SeaNYViewHolder extends RecyclerView.ViewHolder {
        public TextView veganSideName;
        public CheckBox selectedBox;
        public TextView descName;

        public SeaNYViewHolder(@NonNull View itemView) {
            super(itemView);
