...
public class MeatAdapter extends RecyclerView.Adapter<MeatAdapter.MeatViewHolder> {
    ...
    public static ArrayList<ElaahiItem> myMeatItem;
    public Context mAppContext;
    public static int[] ton = {0};
    //int[] total = {0};

    public MeatAdapter(Context context, ArrayList<ElaahiItem> appitiserItems){
        this.mAppContext = context;
        this.myMeatItem = appitiserItems;
    }
    ...
    public MeatViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        MeatViewHolder avh = new MeatViewHolder(v);
        return avh;
    }
    ...
    public void onBindViewHolder(@NonNull MeatViewHolder holder, int position) {
        ...
        ElaahiItem appItem = myMeatItem.get(position);
    ...
    public class MeatViewHolder extends RecyclerView.ViewHolder {
        ...
        public MeatViewHolder(@NonNull View itemView) {
            ...
            for (int i = 0; i< myMeatItem.size(); i++) {
                int hell = Integer.parseInt(myMeatItem.get(i).getMyElaahiQuantity());
            ...
            foodAddAppt.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (ton[0] == no) {
                        ...
                        myMeatItem.get(getAdapterPosition()).setMyElaahiQuantity(String.valueOf(add));
            ...
            foodMinusAppt.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (ton[0] == 0 && n == 0) {
                        ...
                        myMeatItem.get(getAdapterPosition()).setMyElaahiQuantity(String.valueOf(m));
