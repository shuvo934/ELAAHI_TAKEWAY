...
public class TandooriNYAdapter extends RecyclerView.Adapter<TandooriNYAdapter.TanNYViewHolder> {

    private ArrayList<CheckBoxListNew> myVeganSideItem;
    private Context myContext;


    public TandooriNYAdapter(Context context, ArrayList<CheckBoxListNew> mRadio) {
    ...
    @NonNull
    @Override
    public TanNYViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(myContext).inflate(R.layout.sub_course_item, parent,false);
        TanNYViewHolder rbv = new TanNYViewHolder(view);
        return rbv;
    }

    @Override
    public void onBindViewHolder(@NonNull TanNYViewHolder holder, int position) {
    ...
    public class TanNYViewHolder extends RecyclerView.ViewHolder {
        public TextView veganSideName;
        public CheckBox selectedBox;
        public TextView descName;

        public TanNYViewHolder(@NonNull View itemView) {
            super(itemView);
