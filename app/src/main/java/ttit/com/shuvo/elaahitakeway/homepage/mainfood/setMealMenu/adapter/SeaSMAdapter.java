...
public class SeaSMAdapter extends RecyclerView.Adapter<SeaSMAdapter.SSMViewHolder> {
    ...
    public SeaSMAdapter(Context context, ArrayList<CheckBoxListNew> mRadio) {
    ...
    @NonNull
    @Override
    public SSMViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(myContext).inflate(R.layout.sub_course_item, parent,false);
        SSMViewHolder rbv = new SSMViewHolder(view);
        return rbv;
    }

    @Override
    public void onBindViewHolder(@NonNull SSMViewHolder holder, int position) {
        ...
        holder.descNamel.setText(checkBoxList.getCheckBoxDesc());
    ...
    public class SSMViewHolder extends RecyclerView.ViewHolder {
        public TextView veganSideName;
        public CheckBox selectedBox;
        public TextView descNamel;

        public SSMViewHolder(@NonNull View itemView) {
            super(itemView);
            veganSideName = itemView.findViewById(R.id.sub_course_name);
            selectedBox = itemView.findViewById(R.id.sub_course_selected);
            descNamel = itemView.findViewById(R.id.sub_course_desc);
