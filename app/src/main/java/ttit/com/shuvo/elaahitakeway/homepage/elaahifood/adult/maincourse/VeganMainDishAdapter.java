...
public class VeganMainDishAdapter extends RecyclerView.Adapter<VeganMainDishAdapter.VeganMainDishViewHolder> {

    public static ArrayList<ElaahiItem> myVeganMainItem;
    public Context mAppContext;
    public static int[] ton = {0};
    public static String itemsName;
    //int[] total = {0};

    public VeganMainDishAdapter(Context context, ArrayList<ElaahiItem> appitiserItems){
        this.mAppContext = context;
        this.myVeganMainItem = appitiserItems;
    }

    @NonNull
    @Override
    public VeganMainDishViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mAppContext).inflate(R.layout.appitiser_list_item, parent, false);
        VeganMainDishViewHolder avh = new VeganMainDishViewHolder(v);
        return avh;
    }

    @Override
    public void onBindViewHolder(@NonNull VeganMainDishViewHolder holder, int position) {

        ElaahiItem appItem = myVeganMainItem.get(position);
    ...
    public int getItemCount() {
        return myVeganMainItem.size();
    }

    public void tonClass() {
        for (int i = 0; i< myVeganMainItem.size(); i++) {
            int hell = Integer.parseInt(myVeganMainItem.get(i).getMyElaahiQuantity());
    ...
    public class VeganMainDishViewHolder extends RecyclerView.ViewHolder {
        ...
        public VeganMainDishViewHolder(@NonNull View itemView) {
            super(itemView);
            ...
            foodAddAppt.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (ton[0] == no) {
                        ...
                        itemsName = myVeganMainItem.get(getAdapterPosition()).getMyElaahiItem();
                        AppCompatActivity activity = (AppCompatActivity) v.getContext();
                        VeganMainChoiceListDialogue veganMainChoiceListDialogue = new VeganMainChoiceListDialogue();
                        veganMainChoiceListDialogue.show(activity.getSupportFragmentManager(),"vegan");
                        ...
                        myVeganMainItem.get(getAdapterPosition()).setMyElaahiQuantity(String.valueOf(add));
                        Log.i("name of food: ", myVeganMainItem.get(getAdapterPosition()).getMyElaahiItem());

                        for (ItemNameWithSauce items : VeganMainDishDialogue.itemwithVegetable) {
                            //Log.i("ITEMSAUCE: ",items.getItemSauce());
                            if (items.getItemSauce().contains(myVeganMainItem.get(getAdapterPosition()).getMyElaahiItem())) {
                                Log.i("Itemsssss:", items.getItemSauce());
                                Log.i("bal hoi na",items.toString());
                                Log.i("dekhi hoi kina", String.valueOf(VeganMainDishDialogue.itemwithVegetable.indexOf(items)));
            ...
            foodMinusAppt.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (ton[0] == 0 && n == 0) {
                        ...
                        myVeganMainItem.get(getAdapterPosition()).setMyElaahiQuantity(String.valueOf(m));
                        ...
                        for (ItemNameWithSauce items : VeganMainDishDialogue.itemwithVegetable) {
                            ...
                            if (items.getItemSauce().contains(myVeganMainItem.get(getAdapterPosition()).getMyElaahiItem())) {
                                Log.i("Itemsssss:", items.getItemSauce());
                                Log.i("bal hoi na",items.toString());
                                numberOfIndex = VeganMainDishDialogue.itemwithVegetable.indexOf(items);
                                Log.i("dekhi hoi kina", String.valueOf(VeganMainDishDialogue.itemwithVegetable.indexOf(items)));

                            }

                        }
                        VeganMainDishDialogue.itemwithVegetable.remove(numberOfIndex);
                        for (ItemNameWithSauce items : VeganMainDishDialogue.itemwithVegetable) {
                            Log.i("ITEMSAUCE: ",items.getItemSauce());
                        }
