...
public class ChefSDNYAdapter extends RecyclerView.Adapter<ChefSDNYAdapter.ChefNYViewHodler> {

    private ArrayList<CheckBoxListNew> myVeganSideItem;
    private Context myContext;


    public ChefSDNYAdapter(Context context, ArrayList<CheckBoxListNew> mRadio) {
    ...
    @NonNull
    @Override
    public ChefNYViewHodler onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(myContext).inflate(R.layout.sub_course_item, parent,false);
        ChefNYViewHodler rbv = new ChefNYViewHodler(view);
        return rbv;
    }

    @Override
    public void onBindViewHolder(@NonNull ChefNYViewHodler holder, int position) {
    ...
    public class ChefNYViewHodler extends RecyclerView.ViewHolder {
        public TextView veganSideName;
        public CheckBox selectedBox;
        public TextView descName;

        public ChefNYViewHodler(@NonNull View itemView) {
            super(itemView);
