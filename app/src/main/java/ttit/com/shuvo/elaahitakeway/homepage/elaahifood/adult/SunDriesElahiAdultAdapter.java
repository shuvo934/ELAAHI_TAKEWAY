...
public class SunDriesElahiAdultAdapter extends RecyclerView.Adapter<SunDriesElahiAdultAdapter.SunDriesElahiAdultViewHolder> {
    ...
    public SunDriesElahiAdultAdapter(Context context, ArrayList<ElaahiItem> appitiserItems){
    ...
    @NonNull
    @Override
    public SunDriesElahiAdultViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mAppContext).inflate(R.layout.appitiser_list_item, parent, false);
        SunDriesElahiAdultViewHolder avh = new SunDriesElahiAdultViewHolder(v);
        return avh;
    }

    @Override
    public void onBindViewHolder(@NonNull SunDriesElahiAdultViewHolder holder, int position) {
    ...
    public  class SunDriesElahiAdultViewHolder extends RecyclerView.ViewHolder {
        ...
        public SunDriesElahiAdultViewHolder(@NonNull View itemView) {
            super(itemView);
