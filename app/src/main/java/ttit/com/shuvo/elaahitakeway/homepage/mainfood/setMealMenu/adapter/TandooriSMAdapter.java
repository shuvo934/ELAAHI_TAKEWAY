...
public class TandooriSMAdapter extends RecyclerView.Adapter<TandooriSMAdapter.TSMViewHolder> {
    ...
    public TandooriSMAdapter(Context context, ArrayList<CheckBoxListNew> mRadio) {
    ...
    @NonNull
    @Override
    public TSMViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(myContext).inflate(R.layout.sub_course_item, parent,false);
        TSMViewHolder rbv = new TSMViewHolder(view);
        return rbv;
    }

    @Override
    public void onBindViewHolder(@NonNull TSMViewHolder holder, int position) {
    ...
    public class TSMViewHolder extends RecyclerView.ViewHolder {
        public TextView veganSideName;
        public CheckBox selectedBox;
        public TextView descName;

        public TSMViewHolder(@NonNull View itemView) {
            super(itemView);
