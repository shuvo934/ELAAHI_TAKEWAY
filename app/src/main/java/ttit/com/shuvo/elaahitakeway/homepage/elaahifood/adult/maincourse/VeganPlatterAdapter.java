...
public class VeganPlatterAdapter extends RecyclerView.Adapter<VeganPlatterAdapter.VeganPlatterViewHolder> {

    public static ArrayList<ElaahiItem> myVeganPlatterItem;
    public Context mAppContext;
    public static int[] ton = {0};
    public static String itemsName;
    //int[] total = {0};

    public VeganPlatterAdapter(Context context, ArrayList<ElaahiItem> appitiserItems){
        this.mAppContext = context;
        this.myVeganPlatterItem = appitiserItems;
    }

    @NonNull
    @Override
    public VeganPlatterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mAppContext).inflate(R.layout.appitiser_list_item, parent, false);
        VeganPlatterViewHolder avh = new VeganPlatterViewHolder(v);
        return avh;
    }

    @Override
    public void onBindViewHolder(@NonNull VeganPlatterViewHolder holder, int position) {

        ElaahiItem appItem = myVeganPlatterItem.get(position);
    ...
    public int getItemCount() {
        return myVeganPlatterItem.size();
    }

    public void tonClass() {
        for (int i = 0; i< myVeganPlatterItem.size(); i++) {
            int hell = Integer.parseInt(myVeganPlatterItem.get(i).getMyElaahiQuantity());
    ...
    public class VeganPlatterViewHolder extends RecyclerView.ViewHolder {
        ...
        public VeganPlatterViewHolder(@NonNull View itemView) {
            super(itemView);
            ...
            foodAddAppt.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (ton[0] == no) {
                        ...
                        itemsName = myVeganPlatterItem.get(getAdapterPosition()).getMyElaahiItem();
                        AppCompatActivity activity = (AppCompatActivity) v.getContext();
                        VeganPlatterItemDialogue veganPlatterItemDialogue = new VeganPlatterItemDialogue();
                        veganPlatterItemDialogue.show(activity.getSupportFragmentManager(),"veganplatter");
                        ...
                        myVeganPlatterItem.get(getAdapterPosition()).setMyElaahiQuantity(String.valueOf(add));
                        Log.i("name of food: ", myVeganPlatterItem.get(getAdapterPosition()).getMyElaahiItem());

                        for (ItemNameWithSauce items : VeganPlatterDialogue.itemInVeganPlatter) {
                            //Log.i("ITEMSAUCE: ",items.getItemSauce());
                            if (items.getItemSauce().contains(myVeganPlatterItem.get(getAdapterPosition()).getMyElaahiItem())) {
                                Log.i("Itemsssss:", items.getItemSauce());
                                Log.i("bal hoi na",items.toString());
                                Log.i("dekhi hoi kina", String.valueOf(VeganPlatterDialogue.itemInVeganPlatter.indexOf(items)));
            ...
            foodMinusAppt.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (ton[0] == 0 && n == 0) {
                        ...
                        myVeganPlatterItem.get(getAdapterPosition()).setMyElaahiQuantity(String.valueOf(m));
                        ...
                        for (ItemNameWithSauce items : VeganPlatterDialogue.itemInVeganPlatter) {
                            ...
                            if (items.getItemSauce().contains(myVeganPlatterItem.get(getAdapterPosition()).getMyElaahiItem())) {
                                Log.i("Itemsssss:", items.getItemSauce());
                                Log.i("bal hoi na",items.toString());
                                numberOfIndex = VeganPlatterDialogue.itemInVeganPlatter.indexOf(items);
                                Log.i("dekhi hoi kina", String.valueOf(VeganPlatterDialogue.itemInVeganPlatter.indexOf(items)));

                            }

                        }
                        VeganPlatterDialogue.itemInVeganPlatter.remove(numberOfIndex);
                        for (ItemNameWithSauce items : VeganPlatterDialogue.itemInVeganPlatter) {
                            Log.i("ITEMSAUCE: ",items.getItemSauce());
                        }
