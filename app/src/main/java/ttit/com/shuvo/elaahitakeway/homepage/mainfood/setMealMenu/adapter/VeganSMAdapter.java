...
public class VeganSMAdapter extends RecyclerView.Adapter<VeganSMAdapter.VSMViewHolder> {
    ...
    public VeganSMAdapter(Context context, ArrayList<CheckBoxListNew> mRadio) {
    ...
    @NonNull
    @Override
    public VSMViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(myContext).inflate(R.layout.sub_course_item, parent,false);
        VSMViewHolder rbv = new VSMViewHolder(view);
        return rbv;
    }

    @Override
    public void onBindViewHolder(@NonNull VSMViewHolder holder, int position) {
    ...
    public class VSMViewHolder extends RecyclerView.ViewHolder {
        public TextView veganSideName;
        public CheckBox selectedBox;
        public TextView descName;

        public VSMViewHolder(@NonNull View itemView) {
            super(itemView);
