...
public class DessertChildAdapter extends RecyclerView.Adapter<DessertChildAdapter.DessertChildViewHolder> {

    public ArrayList<AppitiserItem> myAppItem;
    public Context mAppContext;
    public static int[] ton = {0};

    public DessertChildAdapter(Context context, ArrayList<AppitiserItem> appitiserItems){
    ...
    @NonNull
    @Override
    public DessertChildViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mAppContext).inflate(R.layout.appitiser_list_item, parent, false);
        DessertChildViewHolder avh = new DessertChildViewHolder(v);
        return avh;
    }

    @Override
    public void onBindViewHolder(@NonNull DessertChildViewHolder holder, int position) {
    ...
    public  class DessertChildViewHolder extends RecyclerView.ViewHolder {
        ...
        public DessertChildViewHolder(@NonNull View itemView) {
            super(itemView);
