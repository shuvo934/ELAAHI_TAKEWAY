...
public class SeaFoodAnotherAdapter extends RecyclerView.Adapter<SeaFoodAnotherAdapter.SeaFoodAnotherViewHolder> {
    ...
    public SeaFoodAnotherAdapter(Context context, ArrayList<SubCategoryItemTag> normalFoodItems) {
    ...
    @NonNull
    @Override
    public SeaFoodAnotherViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(myContext).inflate(R.layout.fooditem, parent, false);
        SeaFoodAnotherViewHolder ammvh = new SeaFoodAnotherViewHolder(v);
        return ammvh;
    }

    @Override
    public void onBindViewHolder(@NonNull SeaFoodAnotherViewHolder holder, int position) {
    ...
    public class SeaFoodAnotherViewHolder extends RecyclerView.ViewHolder {
        ...
        public SeaFoodAnotherViewHolder(@NonNull View itemView) {
            super(itemView);
            ...
            addButtonToCart.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (mainFoodDesc.getText().toString().contains("choice of curry sauce")) {
                        SauceDialogueforMenu sauceDialogueforMenu = new SauceDialogueforMenu();
                        sauceDialogueforMenu.sauceValue = 1;
                        ...
                        quantityDialogue.qunatityValue = 1;
                        quantityDialogue.show(activity.getSupportFragmentManager(),"AAAQQ");
                    }
