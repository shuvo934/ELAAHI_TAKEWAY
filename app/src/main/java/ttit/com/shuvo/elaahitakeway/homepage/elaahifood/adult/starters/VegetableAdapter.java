...
public class VegetableAdapter extends RecyclerView.Adapter<VegetableAdapter.VegetableViewHolder> {
    ...
    public static ArrayList<ElaahiItem> myVegetableItem;
    public Context mAppContext;
    public static int[] ton = {0};
    //int[] total = {0};

    public VegetableAdapter(Context context, ArrayList<ElaahiItem> appitiserItems){
        this.mAppContext = context;
        this.myVegetableItem = appitiserItems;
    }
    ...
    public VegetableViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        VegetableViewHolder avh = new VegetableViewHolder(v);
        return avh;
    }
    ...
    public void onBindViewHolder(@NonNull VegetableViewHolder holder, int position) {
        ...
        ElaahiItem appItem = myVegetableItem.get(position);
    ...
    public  class VegetableViewHolder extends RecyclerView.ViewHolder {
        ...
        public VegetableViewHolder(@NonNull View itemView) {
            ...
            for (int i = 0; i< myVegetableItem.size(); i++) {
                int hell = Integer.parseInt(myVegetableItem.get(i).getMyElaahiQuantity());
            ...
            foodAddAppt.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (ton[0] == no) {
                        ...
                        myVegetableItem.get(getAdapterPosition()).setMyElaahiQuantity(String.valueOf(add));
            ...
            foodMinusAppt.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (ton[0] == 0 && n == 0) {
                        ...
                        myVegetableItem.get(getAdapterPosition()).setMyElaahiQuantity(String.valueOf(m));
