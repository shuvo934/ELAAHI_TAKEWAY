...
public class MainCourseChildAdapter extends RecyclerView.Adapter<MainCourseChildAdapter.MainCourseChildViewHolder>{

    public ArrayList<AppitiserItem> myAppItem;
    public Context mAppContext;
    public static int[] ton = {0};

    public MainCourseChildAdapter(Context context, ArrayList<AppitiserItem> appitiserItems){
    ...
    @NonNull
    @Override
    public MainCourseChildViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mAppContext).inflate(R.layout.appitiser_list_item, parent, false);
        MainCourseChildViewHolder avh = new MainCourseChildViewHolder(v);
        return avh;
    }

    @Override
    public void onBindViewHolder(@NonNull MainCourseChildViewHolder holder, int position) {
    ...
    public  class MainCourseChildViewHolder extends RecyclerView.ViewHolder {
        ...
        public MainCourseChildViewHolder(@NonNull View itemView) {
            super(itemView);
            ...
            ton[0] = 0;
            int no = Integer.parseInt(ChildFestiveCategory.numChild.getText().toString());
