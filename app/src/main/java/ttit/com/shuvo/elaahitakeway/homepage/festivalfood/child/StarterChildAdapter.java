...
public class StarterChildAdapter extends RecyclerView.Adapter<StarterChildAdapter.StarterChildViewHolder> {
    ...
    public StarterChildAdapter(Context context, ArrayList<AppitiserItem> appitiserItems){
    ...
    @NonNull
    @Override
    public StarterChildViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mAppContext).inflate(R.layout.appitiser_list_item, parent, false);
        StarterChildViewHolder avh = new StarterChildViewHolder(v);
        return avh;
    }

    @Override
    public void onBindViewHolder(@NonNull StarterChildViewHolder holder, int position) {
    ...
    public  class StarterChildViewHolder extends RecyclerView.ViewHolder {
        ...
        public StarterChildViewHolder(@NonNull View itemView) {
            super(itemView);
