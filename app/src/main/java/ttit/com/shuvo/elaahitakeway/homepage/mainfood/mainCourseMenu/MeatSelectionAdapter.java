...
public class MeatSelectionAdapter extends RecyclerView.Adapter<MeatSelectionAdapter.MeatSelectionViewHolder> {
    ...
    @NonNull
    @Override
    public MeatSelectionViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(myContext).inflate(R.layout.fooditem, parent, false);
        MeatSelectionViewHolder ammvh = new MeatSelectionViewHolder(v);
        return ammvh;
    }
    ...
    public class MeatSelectionViewHolder extends RecyclerView.ViewHolder {
        ...
        public MeatSelectionViewHolder(@NonNull View itemView) {
            super(itemView);
            ...
            addButtonToCart.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    meatSelectionDialogue.show(activity.getSupportFragmentManager(),"MeatKhao");
                }
            });
        }
    }
