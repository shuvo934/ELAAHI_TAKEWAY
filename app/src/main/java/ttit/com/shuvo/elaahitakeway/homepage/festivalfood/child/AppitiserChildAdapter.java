...
public class AppitiserChildAdapter extends RecyclerView.Adapter<AppitiserChildAdapter.AppitiserChildViewHolder> {
    ...
    public AppitiserChildAdapter(Context context, ArrayList<AppitiserItem> appitiserItems){
    ...
    @NonNull
    @Override
    public AppitiserChildViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mAppContext).inflate(R.layout.appitiser_list_item, parent, false);
        AppitiserChildViewHolder avh = new AppitiserChildViewHolder(v);
        return avh;
    }

    @Override
    public void onBindViewHolder(@NonNull AppitiserChildViewHolder holder, int position) {
    ...
    public  class AppitiserChildViewHolder extends RecyclerView.ViewHolder {
        ...
        public AppitiserChildViewHolder(@NonNull View itemView) {
            super(itemView);
